...
- Name: mobile-pc-regression.spec.ts >> PC端回归验证 >> AC-MOB-012: Hero Banner PC端布局正常
- Location: tests/e2e/mobile-pc-regression.spec.ts:81:3
...
Call log:
  - waiting for locator('.hero-banner')
